          ...
          <Link to="/" className="flex items-center gap-2 group">
            ...
            <div>
              <span className="font-bold text-lg text-slate-900 dark:text-white tracking-tight flex items-center gap-1.5">
                CommunityHub <span className="bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 text-xs px-2 py-0.5 rounded-full font-semibold">SaaS</span>
              </span>
              <span className="text-xs text-slate-500 dark:text-slate-400 block -mt-0.5">
                {user?.community?.name || 'Gated Villa Enclave'}
              </span>
            </div>
          </Link>
        </div>
        ...
        <div className="hidden md:flex items-center flex-1 max-w-md mx-4">
          <div className="relative w-full">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 text-sm bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors"
            />
          </div>
        </div>
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="hidden lg:block text-left">
                  <div className="text-xs font-semibold text-slate-900 dark:text-white leading-snug">{user.name}</div>
                  <div className="text-[10px] text-blue-600 dark:text-blue-400 font-medium">{user.role}</div>
                </div>
              </button>
