...
export const Navbar = ({ onOpenSidebar = () => {} }) => {
  ...
  return (
    <header className="ch-navbar">
      ...
      {/* ── Hamburger — calls onOpenSidebar prop directly ── */}
      <button
      ...
      <div className="ch-navbar-controls">
        ...
        <div className="ch-date-pill">📅 {getTodayString()}</div>
          ...
          <div style={{ position:'relative' }}>
            ...
            {showProfileMenu && (
              <div className="ch-dropdown ch-dropdown--profile">
                ...
                <Link to="/profile" onClick={() => setShowProfileMenu(false)} className="ch-dropdown-item">
